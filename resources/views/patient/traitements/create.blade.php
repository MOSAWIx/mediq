...
<body>
                ...
                <form method="POST" action="{{ route('traitements.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <small style="color: var(--gray); margin-top: 5px; display: block;">
                            Entrez le nom commercial ou générique du médicament
                        </small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            required>
                        <small style="color: var(--gray); margin-top: 5px; display: block;">
                            Précisez la quantité à prendre à chaque prise
                        </small>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const formattedTime = nextHour.getHours().toString().padStart(2, '0') + ':' +
